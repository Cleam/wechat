...
var sstxt = '打开腾讯新闻，提现我的红包'; // 已安装或下载安装完成后的文案
var haolitxt = '立即签到领壕礼';
AppDownload.unicodeTxt.down = '正在下载腾讯新闻';
...
window['getNewsCallback'] = function(result){
	if( result.ret==0 && result.news && result.news.length ){
            ...
            html += '<li>\
                        <div class="sitem clearfix">\
                            ...
                            <div class="text">\
                                ...
                                <div class="btn" data-url="qqnews://article_9527?nm='+item.newsid+'">下载腾讯新闻阅读</div>\
                            </div>\
                        </div>\
                    </li>';
		}
        ...
        if( html ){
            ...
            AppDownload.checkAppIsInstalled(function(){
                $('.news .btn').attr('data-status', 'success').text( '打开腾讯新闻阅读' );
            });
        }
	}
}
